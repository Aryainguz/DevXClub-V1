  ...
  return (
    <Container maxW="5xl" p={{ base: 5, md: 10 }}>
      ...
      >
        ...
        <Stack pos="relative" zMainCTA={1} direction="column" spacing={5} textAlign="left">
          <chakra.h1 color="white" fontSize="4xl" lineHeight={1.2} fontWeight="bold">
           Hey {userName}, Welcome to DevXClub!
          </chakra.h1>
          <chakra.h1 color="gray.400" fontSize="xl" maxW="600px" lineHeight={1.2}>
          Be part of elite events and workshops curated by experts for you and netwok with cool Devs from the community.
          </chakra.h1>
